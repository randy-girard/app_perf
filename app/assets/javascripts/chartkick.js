...
(function (window) {
  ...
  function loadAdapters() {
    if (!HighchartsAdapter && "Highcharts" in window) {
      var HighchartsAdapter = new function () {
        ...
        this.renderAreaSplineChart = function (chart) {
  ...
  function processAreaSplineData(chart) {
    chart.data = processSeries(chart.data, chart.options, "datetime");
    renderChart("AreaSplineChart", chart);
  }
  ...
  Chartkick = {
    ...
    AreaSplineChart: function (element, dataSource, opts) {
      setElement(this, element, dataSource, opts, processAreaSplineData);
    },
