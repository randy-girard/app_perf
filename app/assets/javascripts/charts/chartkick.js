...
(function (window) {
  ...
  function jsOptionsFunc(defaultOptions, hideLegend, setTitle, setMin, setMax, setStacked, setXtitle, setYtitle, setAnnotations) {
  ...
  function loadAdapters() {
    if (!HighchartsAdapter && "Highcharts" in window) {
      HighchartsAdapter = new function () {
        ...
        var setAnnotations = function (options, annotations) {
          options.xAxis.plotLines = annotations;
        }

        var jsOptions = jsOptionsFunc(defaultOptions, hideLegend, setTitle, setMin, setMax, setStacked, setXtitle, setYtitle, setAnnotations);
  ...
  function processSeries(chart, keyType) {
    ...
    chart.annotations = chart.rawData.annotations;

    var opts = chart.options;
    var series = chart.rawData.data;
