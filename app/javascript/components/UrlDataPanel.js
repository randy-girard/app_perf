...
class UrlDataPanel extends React.Component {
  renderData (data) {
    var baseURI = window.location.href;

    return (
      data.map(function(datum, index) {
        var domain = Utils.updateQueryStringParameter(baseURI, "_domain", datum.domain);
        var url = Utils.updateQueryStringParameter(baseURI, "_url", datum.url);
